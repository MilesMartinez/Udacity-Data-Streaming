...
class Line:
    ...
    def _handle_station(self, value):
        ...
        #logger.info("line.py is handling station message")
    ...
    def _handle_arrival(self, message):
        ...
        #logger.info("line.py is handling arrival message")
        value = message.value()
    ...
    def process_message(self, message):
        ...
        elif 'org.chicago.cta.station.arrival' in message.topic(): # Set the conditional to the arrival topic
